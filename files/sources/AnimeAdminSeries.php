...
function anime_admin_series_list() {
	...
	$context['page_index'] = constructPageIndex($scripturl . '?action=admin;area=an-series;sa=listSeries', $_REQUEST['start'], $context['total_articles'], 50);
	$context['start'] = $_REQUEST['start'];

	// Get all the series.
	$context['series'] = getAnimeSeriesInfo(null,null,false);
...
function anime_admin_series_add() {
	...
	// Adding a category? Lets do this thang! ;D
		...
		$seriesInfo = array(
			...
			'specs' => $smcFunc['htmlspecialchars']($_POST['series_specs'], ENT_QUOTES),
...
function anime_admin_series_edit() {
	...
	// Adding a category? Lets do this thang! ;D
		...
		$seriesInfo['specs'] = $smcFunc['htmlspecialchars']($_POST['series_specs'], ENT_QUOTES);
