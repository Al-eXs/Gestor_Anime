...
function anime_admin_news_last() {
	...
	// Get all the series.
	$context['news'] = getAnimeNewsInfo(null,true);
...
function anime_admin_news_list() {
 global $txt, $context, $smcFunc, $scripturl;
	...
	$context['page_index'] = constructPageIndex($scripturl . '?action=admin;area=an-news;sa=listNews', $_REQUEST['start'], $context['total_articles'], 50);
	$context['start'] = $_REQUEST['start'];

	// Get all the series.
	$context['news'] = getAnimeNewsInfo(null,false);
