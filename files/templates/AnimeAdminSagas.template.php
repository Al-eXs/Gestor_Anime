...
function template_sagas_edit()
{
	...
	echo '
						...
						<dt>
							<label for="sagas_specs">', $txt['an-sagasSpecs'], ':</label>
						</dt>
						<dd>
							<textarea name="sagas_specs" rows="10" cols="50">',!empty($context['sagasInfo']['specs']) ? $context['sagasInfo']['specs'] : '','</textarea>
						</dd>
						<dt>
